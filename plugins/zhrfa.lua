...
redis:setex(basmah..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_,500,true)
...
if msg.text and msg.type ~= "pv" and redis:get(basmah..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_) then
redis:del(basmah..":ZhrfNow:"..msg.sender_user_id_..msg.chat_id_)
